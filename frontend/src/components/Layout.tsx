...
import { Shield, LayoutDashboard, Search, Server, FileText, Users, LogOut, Wrench, Zap, Info, Globe, Target } from 'lucide-react'
        ...
        <div className="p-4 border-b border-gray-800">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-gray-400">Security Audit v1.0</div>
            </div>
          </div>
        </div>
